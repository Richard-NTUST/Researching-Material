...
https://trello.com/b/Mi8l1yge/internship

---

讀論文的重點

1. Introduction: 了解專有名詞、了解與本論文相關的過去研究成果，說明本論文要解決的問題、挑戰，與貢獻 (解決挑戰的方法) 
2. System Model/Architecture: 學習定義問題，說明環境、基本假設、題目(I/P) & 答案 (O/P)、評估準則/效能指標
3. Proposed Method: 核心概念、基本假設
4. Simulation/Numercial Results: 確認是否以System Model/Architecture定義的效能指標做圖？確認答案是否真正可解決本論文提出的問題？如何從結果說明、佐證設計理念？

如何閱讀一篇論文：

https://u.pcloud.link/publink/show?code=kZVLkt5ZYCpWMvr3dv04deQxWSjgS0DKcKHX


論文製作模板：

https://chatgpt.com/s/t_69c133a32a2c81918540c58e619c5ca7
...
https://github.com/jtfinn35/Research-Note

光胤同學的筆記：

https://github.com/Marcusnotmarks/My-Study-Notes

---

法國教授的研究網站：

https://www.open6g.us/#/ai
